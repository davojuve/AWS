...
public class DemoNoSQLTableUsers extends DemoNoSQLTableBase {
        ...
        DemoGetWithPartitionKeyAndSortKey(final Context context) {
            super(context.getString(R.string.nosql_operation_get_by_partition_and_sort_text),
                String.format(context.getString(R.string.nosql_operation_example_get_by_partition_and_sort_text),
                    ...
                    "firstName", "demo-userId-500000"));
        }

        @Override
        public boolean executeOperation() {
            // Retrieve an item by passing the partition key using the object mapper.
            result = mapper.load(UsersDO.class, AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID(), "demo-firstName-500000");
    ...
    public class DemoQueryWithPartitionKeyAndSortKeyCondition extends DemoNoSQLOperationBase {
        ...
        private PaginatedQueryList<UsersDO> results;
        ...
        public boolean executeOperation() {
            ...
            final Condition rangeKeyCondition = new Condition()
                ...
                .withAttributeValueList(new AttributeValue().withS("demo-firstName-500000"));
            final DynamoDBQueryExpression<UsersDO> queryExpression = new DynamoDBQueryExpression<UsersDO>()
                .withHashKeyValues(itemToFind)
                .withRangeKeyCondition("firstName", rangeKeyCondition)
                .withConsistentRead(false)
                .withLimit(RESULTS_PER_RESULT_GROUP);

            results = mapper.query(UsersDO.class, queryExpression);
            if (results != null) {
    ...
    public class DemoQueryWithPartitionKeyAndFilter extends DemoNoSQLOperationBase {
        ...
        public boolean executeOperation() {
            ...
            filterExpressionAttributeNames.put("#email", "email");

            final Map<String, AttributeValue> filterExpressionAttributeValues = new HashMap<>();
            filterExpressionAttributeValues.put(":Minemail",
                new AttributeValue().withS("demo-email-500000"));

            final DynamoDBQueryExpression<UsersDO> queryExpression = new DynamoDBQueryExpression<UsersDO>()
                .withHashKeyValues(itemToFind)
                .withFilterExpression("#email > :Minemail")
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        firstItem.setFirstName("demo-firstName-500000");
        firstItem.setEmail(
            DemoSampleDataGenerator.getRandomSampleString("email"));
        firstItem.setExternalId(
            DemoSampleDataGenerator.getRandomSampleString("externalId"));
        firstItem.setExternalProvider(
            DemoSampleDataGenerator.getRandomSampleString("externalProvider"));
        ...
        for (int count = 0; count < SAMPLE_DATA_ENTRIES_PER_INSERT-1; count++) {
            ...
            item.setExternalId(DemoSampleDataGenerator.getRandomSampleString("externalId"));
            item.setExternalProvider(DemoSampleDataGenerator.getRandomSampleString("externalProvider"));
