...
public interface IdentityProvider {
    ...
    /**
     * Gets the user's full name (first + last), assuming user is signed in.
     * @return user name or null if not signed-in.
     */
    String getUserFullName();

    /**
     * Gets the user's id, assuming user is signed in.
     * @return user name or null if not signed-in.
     */
    String getUserId();

    /**
     * Gets the user's first name, assuming user is signed in.
     * @return user first name or null if not signed-in.
     */
    String getUserFirstName();

    /**
     * Gets the user's last name, assuming user is signed in.
     * @return user last name or null if not signed-in.
     */
